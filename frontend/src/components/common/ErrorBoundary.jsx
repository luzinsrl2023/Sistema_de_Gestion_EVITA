...
import Modal from '../common/Modal'; // 👈 Usa esta si Modal es export default
// Si Modal es exportado como "export const Modal = ...;", usa en su lugar:
        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
          <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-300 mb-6">
              Se produjo un error al cargar el módulo solicitado. Por favor
              recarga la página o presiona "Reintentar".
            </p>
