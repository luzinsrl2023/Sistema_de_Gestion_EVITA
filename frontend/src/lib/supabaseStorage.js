 ...
 */
// Importante: no crear buckets desde el cliente en producción (RLS lo bloquea).
// Mantener esta función solo para desarrollo local si fuera necesario.
export const initializeBuckets = async () => {
  try {
    if (!import.meta.env.DEV) {
      console.log('initializeBuckets omitido en producción. Crear buckets desde el panel o migraciones.')
      return true
    }
