  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleGeneratePDF} className="p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors" title="Descargar OC en PDF">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        <form id="orden-form" className="space-y-6">
